...
"""
DFA code from: https://github.com/lightonai/dfa-scales-to-modern-deep-learning/blob/master/TinyDFA/tinydfa/light_dfa.py
"Direct Feedback Alignment Scales to Modern Deep Learning Tasks and Architectures"

I've simply replaced 'random_projection' with a nonnegative matrix when mono=True.
"""
